    ...
    public class AngularRoutesMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            if (context.Response.StatusCode == 404
                && !context.Request.Path.Value.StartsWith(Startup.ApiRootPath, StringComparison.OrdinalIgnoreCase)
                && !context.Request.Path.Value.StartsWith(Startup.WebSocketRootPath, StringComparison.OrdinalIgnoreCase))
            {
